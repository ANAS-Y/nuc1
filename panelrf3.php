...
<h6 style="text-align: center;">"D" (Academic Regulations )</h6>
</div>
...
<h6 style="text-align:center;">Academic Regulations Submited report</h6>  
</div>
<form>
...
<div class="card-title ">
<h5 style="text-align: center;">Academic Regulation </h5>
<h6 style="text-align:center;">The Academic Regulation of the Programme</h6>  
</div>
<form>
<div class="form-row" >
     <div class="form-group" >
 ...
 <div class="form-row">
 <div class="col">
 <a class="btn btn-primary login-btn" href="panelrf2.php" style="float: right;margin-right: 4%; width: 95%; ">Previous</a>
 </div>
 <div class="col">
