...
<h6 style="text-align: center;">"C" (Admission Requirements )</h6>
</div>
...
<h6 style="text-align:center;">Submited Admission Requirements report</h6>  
</div>
<form>
...
<div class="card-title ">
<h5 style="text-align: center;">Admission Requirements </h5>
<h6 style="text-align:center;">The Admission Requirements of the Programme</h6>  
</div>
<form>
<div class="form-row" >
     <div class="form-group" >
 ...
 <div class="form-row">
 <div class="col">
 <a class="btn btn-primary login-btn" href="panelrf1.php" style="float: right;margin-right: 4%; width: 95%; ">Previous</a>
 </div>
 <div class="col">
