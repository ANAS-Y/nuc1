...
<h6 style="text-align: center;">"K" Financing (Income, Recurrent and Capital Expenditure) </h6>
</div>
...
<h6 style="text-align:center;">Financing (Income, Recurrent and Capital Expenditure) Submited report</h6>  
</div>
<form>
...
<h6 style="text-align:center;">The Financing (Income, Recurrent and Capital Expenditure) of the Programme</h6>  
</div>
<form>
<div class="form-row" >
     <div class="form-group" >
        <textarea class="form-control" id="curriculum" rows="5" cols="60" name="objectives" required="required"> 
</textarea>
  </div>
  </div>
