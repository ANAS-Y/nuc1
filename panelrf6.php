...
<h6 style="text-align: center;">"G" (External Examiners System)</h6>
</div>
...
<h6 style="text-align:center;">External Examiners System Submited report</h6>  
</div>
<form>
...
<h6 style="text-align:center;">The External Examiners System of the Programme</h6>  
</div>
<form>
<div class="form-row" >
     <div class="form-group" >
 ...
 <div class="form-row">
 <div class="col">
 <a class="btn btn-primary login-btn" href="panelrf5.php" style="float: right;margin-right: 4%; width: 95%; ">Previous</a>
 </div>
 <div class="col">
