...
<h6 style="text-align: center;">"I" Physical Facilities (Laboratories,Classrooms,Equipment,Safety and Environment Sanitation) </h6>
</div>
...
<h6 style="text-align:center;">Physical Facilities Submited report</h6>  
</div>
<form>
...
<div class="card-title ">
<h5 style="text-align: center;">Physical Facilities</h5>
<h6 style="text-align:center;">The Physical Facilities of the Programme</h6>  
</div>
<form>
<div class="form-row" >
     <div class="form-group" >
 ...
 <div class="form-row">
 <div class="col">
 <a class="btn btn-primary login-btn" href="panelrf7.php" style="float: right;margin-right: 4%; width: 95%; ">Previous</a>
 </div>
 <div class="col">
